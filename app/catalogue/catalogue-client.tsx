...
type CatalogueRow = {
  ...
  product: { sku: string; nameEn: string; nameAr: string; status: string; brand?: string | null; model?: string | null; category?: { name: string } | null; primaryImageUrl?: string | null };
